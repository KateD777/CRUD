            ...
            <div className="form shadow-md border border-gray-400 rounded-xl py-6 px-9  ">
                ...
                <div className="top">
                    ...
                    <div className="flex gap-[40px] mb-5 items-center">
                        ...
                        {/* text  */}
                        <h1 className='text-2xl font-semibold'>Изменить данные</h1>
                    </div>
                </div>
                ...
                <div className="bottom">
                    ...
                    {/* Update Button  */}
                    <div>
                        <button onClick={updateEmployee} className=' bg-gray-100 hover:bg-gray-200 w-full py-1.5 border border-gray-400 rounded-md font-medium mb-5'>Сохранить изменения</button>
                    </div>
                </div>
            </div>
        </div>
